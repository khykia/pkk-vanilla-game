...
var playing = false; // Menandakan apakah permainan sedang berlangsung atau tidak

function startGame() {
  if (playing) return; // Jika permainan sudah berlangsung, kembali

  playing = true; // Atur status permainan menjadi sedang berlangsung
